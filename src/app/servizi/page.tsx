...
export default function page() {
  return (
    <div className="flex flex-col items-center justify-center gap-[300px]">
      <section className="w-[1440px] flex flex-col items-center justify-center h-[700px] gap-[100px] my-[50px]">
        <h1 className="font-playfair text-6xl text-cyan-700 italic">
          I nostri trattamenti, pensati per te
        </h1>
        <h3 className="text-2xl font-quicksand text-center leading-[2.5]">
          ...
          distinctio. Amet illum esse facilis inventore in. Maiores fuga facere
          doloremque laudantium fugit ipsa ad deserunt distinctio.
        </h3>
