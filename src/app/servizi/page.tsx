  ...
  return (
    <div className="flex flex-col items-center justify-center gap-[300px]">
      <div className="flex w-full bg-cream items-center justify-center">
        <section className="w-[80vw]  h-[700px]  ">
          <div className="w-[50%] flex flex-col justify-center gap-[100px] my-[50px]">
            <h1 className="font-playfair text-6xl text-cyan-700 italic">
              I nostri trattamenti, pensati per te
            </h1>
            <h3 className="text-2xl font-quicksand leading-[2.5] text-gray-500">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit a
              eveniet neque pariatur minus. Amet illum esse facilis inventore
              in. Maiores fuga facere doloremque laudantium fugit ipsa ad
              deserunt distinctio. Amet illum esse facilis inventore in. Maiores
              fuga facere doloremque laudantium fugit ipsa ad deserunt
              distinctio.
            </h3>
